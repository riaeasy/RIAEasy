...
define([
...
], function(rias, array, Deferred, aspect, sorter, declare, dom, domClass, kernel, lang, query, when,
			QueryResults, _WidgetBase, _TemplatedMixin, _CssStateMixin, _FormWidgetMixin){
	...
	var _FormSelectWidget = declare("riasw.form._FormSelectWidget", [_WidgetBase, _TemplatedMixin, _CssStateMixin, _FormWidgetMixin], {
		// summary:
		//		Extends _FormWidgetMixin in order to provide "select-specific"
		...
		getOptions: function(/*anything*/ valueOrIdx){
			...
			//		(See riasw/form/_FormSelectWidget.__SelectOption).
			//
			//		If passed in a number, then the option with the given index (0-based)
			//		within this select will be returned.
			//
			//		If passed in a riasw/form/_FormSelectWidget.__SelectOption, the same option will be
			...
			//		- A riasw/form/_FormSelectWidget.__SelectOption is passed in which is not a part of the select

			// NOTE: the compare for passing in a riasw/form/_FormSelectWidget.__SelectOption checks
		...
		_deprecatedSetStore: function(store, selectedValue, fetchArgs){
			...
			if(store && store.query){
				...
				when(this._queryRes, lang.hitch(this, function(items){
					...
					console.error('riasw.form._FormSelectWidget: ' + err.toString());
