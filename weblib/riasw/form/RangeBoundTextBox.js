...
], function(rias, MappedTextBox) {

	var riaswType = "riasw.form.RangeBoundTextBox";
	var Widget = rias.declare(riaswType, [MappedTextBox], {
		...
		rangeCheck: function(/*Number*/ primitive, /*riasw/form/RangeBoundTextBox.__Constraints*/ constraints){
			// summary:
		...
		isValid: function(/*Boolean*/ isFocused){
			// Overrides riasw/form/ValidationTextBox.isValid() to check that the value is also in range.
			return this.inherited(arguments) &&
				((this._isEmpty(this.textbox.value) && !this.required) || this.isInRange(isFocused)); // Boolean
		},

		getErrorMessage: function(/*Boolean*/ isFocused){
			// Overrides riasw/form/ValidationTextBox.getErrorMessage() to print "out of range" message if appropriate
