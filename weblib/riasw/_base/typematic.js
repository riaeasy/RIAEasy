	...
	var typematic = {
		...
		_fireEventAndReload: function(){
			...
			this._currentTimeout = Math.max(
				...
				this._minDelay);
			this._timer = setTimeout(rias.hitch(this, "_fireEventAndReload"), this._currentTimeout);
		},
		...
		trigger: function(/*Event*/ evt, /*Object*/ _this, /*DOMNode*/ node, /*Function*/ callback, /*Object*/ obj, /*Number?*/ subsequentDelay, /*Number?*/ initialDelay, /*Number?*/ minDelay){
			...
			if(obj !== this._obj){
				...
				this._count = -1;
				this._callback = rias.hitch(_this, callback);
				this._evt = { faux: true };
				for(var attr in evt){
		...
		addKeyListener: function(/*DOMNode*/ node, /*Object*/ keyObject, /*Object*/ _this, /*Function*/ callback, /*Number*/ subsequentDelay, /*Number*/ initialDelay, /*Number?*/ minDelay){
			...
			var type = "keyCode" in keyObject ? "keydown" : "charCode" in keyObject ? "keypress" : "keypress",//connect._keypress,
				attr = "keyCode" in keyObject ? "keyCode" : "charCode" in keyObject ? "charCode" : "charOrCode";

			var handles = [
				on(node, type, rias.hitch(this, function(evt){
				...
				on(node, "keyup", rias.hitch(this, function(){
			...
			return {
				remove: function(){
					rias.forEach(handles, function(h){
						h.remove();
					});
				}
			};
			...
			var self = this,
				handles = [
					...
					on(node, "dblclick", function(evt){
						...
						if(rias.has("ie") < 9){
							typematic.trigger(evt, _this, node, callback, node, subsequentDelay, initialDelay, minDelay);
							setTimeout(rias.hitch(self, typematic.stop), 50);
						}
					})
				];
			return {
