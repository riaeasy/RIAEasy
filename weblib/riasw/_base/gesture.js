...
=====*/
	...
	var Base = rias.declare("riasw.gesture.Base", null, {
	...
	var Tap = rias.declare("riasw.gesture.Tap", Base, {
		// defaultEvent: [readonly] String
		//		Default event - 'tap'
		defaultEvent: "tap",
	...
	var Swipe = rias.declare("riasw.gesture.Swipe", Base, {
