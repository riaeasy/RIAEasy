...
define([
	...
	rias.theme.loadThemeCss([
		"riasw/layout/GridContainer.css",
		"riasw/layout/DndGridContainer.css"
	]);

	var riaswType = "riasw.layout.GridContainer";
	...
	Widget._riasdMeta = {
		...
		"property": {
			...
			"isContainer": {
				"datatype": "boolean",
				"description": "Just a flag indicating that this widget descends from riasw/sys._Container",
				"hidden": true,
				"defaultValue": true
			},
			"acceptTypes": {
