define([
...
], function(rias, _WidgetBase, _TemplatedMixin, _PaletteMixin) {
	...
	var Emoticon = rias.declare(pluginsName + ".Emoticon", null, {
			...
			imgHtml: function(/*String*/ clazz){
				...
				var eId = "emoticon" + this.id.substr(0,1).toUpperCase() + this.id.substr(1),
					...
					src = rias.toUrl(pluginsName.replace(/\./g, "/") + "/images/emoticons/" + eId + ".gif"),
			...
			fillCell: function(/*DOMNode*/cell, /*String*/ blankGif){
				rias.dom.place(this.imgHtml("riaswPaletteImg"), cell);
			}
	});
	...
	var SmileyPalette = rias.declare(pluginsName + "._SmileyPalette", [_WidgetBase, _TemplatedMixin, _PaletteMixin], {
		// summary:
		...
		templateString:
			'<table class="dijitInline riaswEditorSmileyPalette riaswPaletteTable" cellSpacing=0 cellPadding=0>' +
				'<tbody data-dojo-attach-point="gridNode"></tbody>' +
			'</table>',

		baseClass: "riaswEditorSmileyPalette",
