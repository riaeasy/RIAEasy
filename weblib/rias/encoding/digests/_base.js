...
define([
	...
	var digests = rias.getObject("digests", true, encoding);
	...
	//	word-based addition
	digests.addWords = function(/* word */a, /* word */b){
		// summary:
	...
	digests.stringToWord = function(/* string */s){
		// summary:
	...
	digests.wordToString = function(/* word[] */wa){
		// summary:
	...
	digests.wordToHex = function(/* word[] */wa){
		// summary:
	...
	digests.wordToBase64 = function(/* word[] */wa){
		// summary:
	...
	//	convert to UTF-8
	digests.stringToUtf8 = function(input){
		var output = "";
		var i = -1;
		var x, y;
