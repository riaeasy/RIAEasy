...
define([
	...
	function core(x, len){
		...
		for(var i = 0; i < x.length; i += 16){
			...
			for(var j = 0; j < 80; j++){
				...
				var t = digests.addWords(digests.addWords(R(a, 5), FT(j, b, c, d)), digests.addWords(digests.addWords(e, w[j]), KT(j)));
				e = d;
				d = c;
				c = R(b, 30);
				b = a;
	...
	//	public function
	digests.SHA1 = function(/* String */data, /* dojox.encoding.digests.outputTypes? */outputType){
		// summary:
	...
	digests.SHA1._hmac = function(/* string */data, /* string */key, /* dojox.encoding.digests.outputTypes? */outputType){
		// summary:
