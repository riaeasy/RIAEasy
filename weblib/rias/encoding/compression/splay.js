...
define([
	...
	"rias/riasBase",
	"../bits"
], function(encoding, rias, bits) {

	var compression = rias.getObject("compression", true, encoding);
	...
	rias.prototypeExtend(compression.Splay, {
		reset: function(){
			var i;
