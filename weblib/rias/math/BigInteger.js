...
define([
	...
	// The API for rias.math.BigInteger closely resembles that of the java.math.BigInteger class in Java.
	...
	rias.prototypeExtend(Montgomery, {
		convert:	montConvert,
		revert:		montRevert,
		reduce:		montReduce,
		mulTo:		montMulTo,
