...
define([
	...
	var matrix = rias.getObject("matrix", true, math);
	...
	rias.mixin(matrix, {
		...
		adjoint: function(/* Array */a){
			...
			var m = this.create(tms, tms),
				ap = this.create(tms - 1, tms - 1);
			var ii = 0,
				jj = 0,
				ia = 0,
				ja = 0,
