...
define([
	...
	math.round = function(/*Number*/value, /*Number?*/places, /*Number?*/increment){
		// summary:
		...
		//	|	1
		//	|	>>> rias.math.round(4.8-(1.1+2.2))
		//	|	2
		//	|	>>> ((4.8-(1.1+2.2))/100)
		//	|	0.014999999999999996
		//	|	>>> ((4.8-(1.1+2.2))/100).toFixed(2)
		//	|	"0.01"
		//	|	>>> rias.math.round((4.8-(1.1+2.2))/100,2)
		//	|	0.02
		//	|	>>> rias.math.round(10.71, 0, 2.5)
		//	|	10.75
		//	|	>>> dojo.number.round(162.295, 2)
		//	|	162.29
		//	|	>>> rias.math.round(162.295, 2)
		//	|	162.3
