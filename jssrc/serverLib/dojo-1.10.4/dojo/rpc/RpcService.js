...
define("dojo/rpc/RpcService", ["../_base/array", "../_base/declare", "../_base/Deferred", "../_base/kernel", "../_base/lang", "../_base/url", "../_base/xhr"], function (array, declare, Deferred, kernel, lang, _Url, xhr) {
    return declare("dojo.rpc.RpcService", null, {constructor:function (args) {
        if (args) {
            if ((lang.isString(args)) || (args instanceof _Url)) {
                ...
                var def = xhr.get({url:url, handleAs:"json-comment-optional", sync:true});
