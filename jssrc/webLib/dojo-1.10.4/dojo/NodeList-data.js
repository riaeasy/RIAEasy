...
define("dojo/NodeList-data", ["./_base/kernel", "./query", "./_base/lang", "./_base/array", "./dom-attr"], function (dojo, query, lang, array, attr) {
    ...
    lang.extend(NodeList, {data:NodeList._adaptWithCondition(dodata, function (a) {
