...
define("dojo/dnd/Manager", ["../_base/array", "../_base/declare", "../_base/lang", "../_base/window", "../dom-class", "../Evented", "../has", "../keys", "../on", "../topic", "../touch", "./common", "./autoscroll", "./Avatar"], function (array, declare, lang, win, domClass, Evented, has, keys, on, topic, touch, dnd, autoscroll, Avatar) {
    var Manager = declare("dojo.dnd.Manager", [Evented], {constructor:function () {
        ...
        this.events = [];
    }, OFFSET_X:1 ? 0 : 16, OFFSET_Y:1 ? -64 : 16, overSource:function (source) {
        if (this.avatar) {
