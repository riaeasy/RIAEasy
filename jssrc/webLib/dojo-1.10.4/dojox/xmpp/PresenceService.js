...
define("dojox/xmpp/PresenceService", ["dijit", "dojo", "dojox"], function (dijit, dojo, dojox) {
    ...
    dojo.declare("dojox.xmpp.PresenceService", null, {constructor:function (xmppService) {
        ...
        var props = {id:this.session.getNextIqId(), from:this.session.jid + "/" + this.session.resource, type:"set"};
        ...
        req.append("</query>");
        req.append("</iq>");
        props = {id:this.session.getNextIqId(), from:this.session.jid + "/" + this.session.resource, type:"set"};
        var req2 = new dojox.string.Builder(dojox.xmpp.util.createElement("iq", props, false));
        req2.append(dojox.xmpp.util.createElement("query", {xmlns:"jabber:iq:privacy"}, false));
