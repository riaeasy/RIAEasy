...
define("dojox/xmpp/RosterService", ["dijit", "dojo", "dojox"], function (dijit, dojo, dojox) {
    ...
    dojo.declare("dojox.xmpp.RosterService", null, {constructor:function (xmppSession) {
        ...
        var req = {id:iqId, from:this.session.jid + "/" + this.session.resource, type:"set"};
