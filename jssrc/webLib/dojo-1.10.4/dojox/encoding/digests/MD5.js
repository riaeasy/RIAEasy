...
define("dojox/encoding/digests/MD5", ["./_base"], function (base) {
    ...
    function C(q, a, b, x, s, t) {
        return base.addWords(R(base.addWords(base.addWords(a, q), base.addWords(x, t)), s), b);
    }
    ...
    base.MD5 = function (data, outputType) {
        ...
        switch (out) {
          ...
          case base.outputTypes.Hex:
            return base.wordToHex(wa);
          case base.outputTypes.String:
            return base.wordToString(wa);
          default:
            return base.wordToBase64(wa);
        }
    };
    base.MD5._hmac = function (data, key, outputType) {
        var out = outputType || base.outputTypes.Base64;
