...
define("dojox/encoding/compression/lzw", ["dojo/_base/lang", "../bits"], function (lang, bits) {
    ...
    lang.extend(lzw.Encoder, {init:function () {
        this.dict = {};
    ...
    lang.extend(lzw.Decoder, {init:function () {
