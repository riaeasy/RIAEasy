...
define("dojox/encoding/bits", ["dojo/_base/lang"], function (lang) {
    var bits = lang.getObject("dojox.encoding.bits", true);
    bits.OutputStream = function () {
        this.reset();
    };
    lang.extend(bits.OutputStream, {reset:function () {
        this.buffer = [];
        this.accumulator = 0;
        this.available = 8;
    ...
    lang.extend(bits.InputStream, {getBits:function (width) {
        var r = 0;
        while (width) {
