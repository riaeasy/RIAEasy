...
define("dojox/calc/GraphPro", ["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/window", "dojo/dom-style", "dojo/dom-construct", "dojo/dom-geometry", "dojo/ready", "dojox/calc/Standard", "dojox/calc/Grapher", "dojox/layout/FloatingPane", "dojo/text!./templates/GraphPro.html", "dojox/calc/_Executor", "dijit/Menu", "dijit/MenuItem", "dijit/form/ComboButton", "dijit/form/Button", "dijit/form/TextBox"], function (declare, lang, win, domStyle, domConstruct, domGeometry, ready, Standard, calc, FloatingPane, template) {
    return declare("dojox.calc.GraphPro", Standard, {templateString:template, grapher:null, funcMaker:null, aFloatingPane:null, executorLoaded:function () {
        ...
        this.funcMaker = new calc.FuncGen({writeStore:that.writeStore, readStore:that.readStore, functions:that.functions, deleteFunction:that.executor.deleteFunction, onSaved:function () {
            var name, body;
            if ((name = this.combo.get("value")) == "") {
                this.status.set("value", "The function needs a name");
            } else {
                if ((body = this.textarea.get("value")) == "") {
        ...
        }, saveFunction:lang.hitch(that, that.saveFunction)}, d);
        ...
        var that = this;
        var d = domConstruct.create("div");
        this.grapher = new calc.Grapher({myPane:this.aFloatingPane, drawOne:function (i) {
