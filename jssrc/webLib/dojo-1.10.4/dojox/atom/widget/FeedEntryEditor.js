...
define("dojox/atom/widget/FeedEntryEditor", ["dojo/_base/kernel", "dojo/_base/lang", "dojo/_base/connect", "dojo/_base/declare", "dojo/_base/fx", "dojo/_base/sniff", "dojo/dom", "dojo/dom-style", "dojo/dom-construct", "dijit/_Widget", "dijit/_Templated", "dijit/_Container", "dijit/Editor", "dijit/form/TextBox", "dijit/form/SimpleTextarea", "./FeedEntryViewer", "../io/model", "dojo/text!./templates/FeedEntryEditor.html", "dojo/text!./templates/PeopleEditor.html", "dojo/i18n!./nls/FeedEntryViewer", "dojo/i18n!./nls/FeedEntryEditor", "dojo/i18n!./nls/PeopleEditor"], function (dojo, lang, connect, declare, fx, has, domUtil, domStyle, domConstruct, _Widget, _Templated, _Container, Editor, TextBox, SimpleTextarea, FeedEntryViewer, model, template, peopleEditorTemplate, i18nViewer, i18nEditor, i18nPeople) {
    dojo.experimental("dojox.atom.widget.FeedEntryEditor");
    var FeedEntryEditor = declare("dojox.atom.widget.FeedEntryEditor", FeedEntryViewer, {_contentEditor:null, _oldContent:null, _setObject:null, enableEdit:false, _contentEditorCreator:null, _editors:{}, entryNewButton:null, _editable:false, templateString:template, postCreate:function () {
        ...
        if (entrySelectionEvent.source != this && entrySelectionEvent.action == "delete" && entrySelectionEvent.entry && entrySelectionEvent.entry == this._entry) {
            domStyle.set(this.entryEditButton, "display", "none");
        }
    ...
    }, _createEditor:function (anchorNode, node, multiline, rte) {
        var viewNode;
        var box;
        if (!node) {
            if (rte) {
                return {anchorNode:anchorNode, entryValue:"", editor:null, generateEditor:function () {
        ...
        if (rte) {
            ...
            return {anchorNode:anchorNode, entryValue:value, editor:null, generateEditor:function () {
                var node = document.createElement("div");
                node.innerHTML = this.entryValue;
                this.anchorNode.appendChild(node);
                var _editor = new Editor({}, node);
        ...
        if (target === this.entryTitleSelect) {
            ...
            if (target === this.entrySummarySelect) {
    ...
    }, _createPeopleEditor:function (anchorNode, node) {
    ...
    }, _handleSave:function (entry, location) {
        this._editMode = false;
        this.clear();
    ...
    var PeopleEditor = declare("dojox.atom.widget.PeopleEditor", [_Widget, _Templated, _Container], {templateString:peopleEditorTemplate, _rows:[], _editors:[], _index:0, _numRows:0, postCreate:function () {
        ...
        this._editors = [];
    }, _createEditors:function (name, email, uri, index, widgetName) {
    ...
    }, _createEditor:function (value, id, name, labelNode, node) {
        var row = document.createElement("tr");
        labelNode.appendChild(row);
