...
define("dojox/date/buddhist/locale", ["../..", "dojo/_base/lang", "dojo/_base/array", "dojo/date", "dojo/i18n", "dojo/regexp", "dojo/string", "./Date", "dojo/i18n!dojo/cldr/nls/buddhist"], function (dojox, lang, arr, dd, i18n, regexp, string, BDate) {
    ...
    blocale.format = function (dateObject, options) {
        options = options || {};
    ...
    blocale.regexp = function (options) {
        return blocale._parseInfo(options).regexp;
    };
    blocale._parseInfo = function (options) {
        options = options || {};
        var locale = i18n.normalizeLocale(options.locale);
        var bundle = blocale._getBuddhistBundle(locale);
        var formatLength = options.formatLength || "short";
    ...
    blocale.parse = function (value, options) {
    ...
    var _customFormats = [];
    blocale.addCustomFormats = function (packageName, bundleName) {
        _customFormats.push({pkg:packageName, name:bundleName});
    };
    blocale._getBuddhistBundle = function (locale) {
        var buddhist = {};
    ...
    blocale.getNames = function (item, type, context, locale, date) {
        var label;
