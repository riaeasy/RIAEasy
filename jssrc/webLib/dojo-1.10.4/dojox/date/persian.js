...
define("dojox/date/persian", ["..", "dojo/_base/lang", "dojo/date", "./persian/Date"], function (dojox, lang, dd, IDate) {
    ...
    dpersian.getDaysInMonth = function (month) {
        return month.getDaysInPersianMonth(month.getMonth(), month.getFullYear());
    };
    dpersian.compare = function (date1, date2, portion) {
    ...
    dpersian.add = function (date, interval, amount) {
    ...
    dpersian.difference = function (date1, date2, interval) {
