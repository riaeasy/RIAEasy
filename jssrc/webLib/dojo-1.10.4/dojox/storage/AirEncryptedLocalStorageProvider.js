...
define("dojox/storage/AirEncryptedLocalStorageProvider", ["dijit", "dojo", "dojox", "dojo/require!dojox/storage/manager,dojox/storage/Provider"], function (dijit, dojo, dojox) {
    ...
    if (dojo.isAIR) {
        (function () {
            ...
            air.EncryptedLocalStore = window.runtime.flash.data.EncryptedLocalStore, dojo.declare("dojox.storage.AirEncryptedLocalStorageProvider", [dojox.storage.Provider], {initialize:function () {
