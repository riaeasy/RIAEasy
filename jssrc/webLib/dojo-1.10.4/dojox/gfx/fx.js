...
define("dojox/gfx/fx", ["dojo/_base/lang", "./_base", "./matrix", "dojo/_base/Color", "dojo/_base/array", "dojo/_base/fx", "dojo/_base/connect", "dojo/sniff"], function (lang, g, m, Color, arr, fx, Hub, has) {
    var fxg = g.fx = {};
    ...
    fxg.animateTransform = function (args) {
        ...
        if (g.renderer === "svg" && has("ie") >= 10) {
            var handlers = [Hub.connect(anim, "onBegin", anim, function () {
