...
define("dojox/layout/dnd/PlottedDnd", ["dijit", "dojo", "dojox", "dojo/require!dojo/dnd/Source,dojo/dnd/Manager,dojox/layout/dnd/Avatar"], function (dijit, dojo, dojox) {
    ...
    dojo.declare("dojox.layout.dnd.PlottedDnd", [dojo.dnd.Source], {GC_OFFSET_X:dojo.dnd.manager().OFFSET_X, GC_OFFSET_Y:dojo.dnd.manager().OFFSET_Y, constructor:function (node, params) {
        ...
        dojo.forEach(this.node.childNodes, function (child) {
            ...
            child.coords = {xy:c, w:child.offsetWidth / 2, h:child.offsetHeight / 2, mw:c.w};
            if (height) {
                child.coords.mh = c.h;
            }
        }, this);
        ...
        if (this.current) {
            ...
            before = this.horizontal ? (e.pageX - this.current.coords.xy.x) < this.current.coords.w : (e.pageY - this.current.coords.xy.y) < this.current.coords.h;
    ...
    dojo.extend(dojo.dnd.Manager, {canDrop:function (flag) {
