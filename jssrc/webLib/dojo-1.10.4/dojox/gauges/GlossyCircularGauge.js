...
define("dojox/gauges/GlossyCircularGauge", ["dojo/_base/declare", "dojo/_base/Color", "./GlossyCircularGaugeBase"], function (declare, Color, GlossyCircularGaugeBase) {
    return declare("dojox.gauges.GlossyCircularGauge", [GlossyCircularGaugeBase], {_designWidth:376.25, _designHeight:382.5, _designCx:187.19173, _designCy:187.81589, _designTextIndicatorX:187.19173, _designTextIndicatorY:267.81589, constructor:function () {
        this.startAngle = -135;
        this.endAngle = 135;
        this.min = 0;
        this.max = 100;
        ...
        var transform = {xx:scale, xy:0, yx:0, yy:scale, dx:(-161) * scale + (this.width - scale * this._designWidth) / 2, dy:(-263.5) * scale + (this.height - scale * this._designHeight) / 2};
        ...
        var scale = Math.min((this.width / this._designWidth), (this.height / this._designHeight));
        var transform = {xx:scale, xy:0, yx:0, yy:scale, dx:(-160) * scale + (this.width - scale * this._designWidth) / 2, dy:(-263.5) * scale + (this.height - scale * this._designHeight) / 2};
        var lighterColor1 = Color.blendColors(new Color(this.color), new Color("white"), 0.4);
        var lighterColor2 = Color.blendColors(new Color(this.color), new Color("white"), 0.8);
        if (this._foreground) {
        ...
        group1.setTransform({xx:1.25, xy:0, yx:0, yy:-1.25, dx:-43.30358, dy:1015.57642});
