...
define("dojox/drawing/tools/Line", ["dojo/_base/lang", "../util/oo", "../manager/_registry", "../stencil/Line"], function (lang, oo, registry, StencilLine) {
    var Line = oo.declare(StencilLine, function () {
    }, {draws:true, showAngle:true, onTransformEnd:function (anchor) {
    ...
    Line.setup = {name:"dojox.drawing.tools.Line", tooltip:"Line Tool", iconClass:"iconLine"};
