...
define("dojox/drawing/tools/Ellipse", ["dojo/_base/lang", "../util/oo", "../manager/_registry", "../stencil/Ellipse"], function (lang, oo, registry, StencilEllipse) {
    var Ellipse = oo.declare(StencilEllipse, function () {
    ...
    Ellipse.setup = {name:"dojox.drawing.tools.Ellipse", tooltip:"Ellipse Tool", iconClass:"iconEllipse"};
