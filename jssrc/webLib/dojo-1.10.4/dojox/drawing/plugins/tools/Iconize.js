...
define("dojox/drawing/plugins/tools/Iconize", ["dojo", "../../util/oo", "../_Plugin", "../../manager/_registry"], function (dojo, oo, Plugin, registry) {
    var Iconize = oo.declare(Plugin, function (options) {
    }, {onClick:function () {
        var item;
    ...
    Iconize.setup = {name:"dojox.drawing.plugins.tools.Iconize", tooltip:"Iconize Tool", iconClass:"iconPan"};
