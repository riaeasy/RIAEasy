...
define("dojox/dgauges/components/green/SemiCircularLinearGauge", ["dojo/_base/lang", "dojo/_base/declare", "dojo/_base/Color", "../utils", "../../CircularGauge", "../../LinearScaler", "../../CircularScale", "../../CircularValueIndicator", "../../CircularRangeIndicator", "../DefaultPropertiesMixin"], function (lang, declare, Color, utils, CircularGauge, LinearScaler, CircularScale, CircularValueIndicator, CircularRangeIndicator, DefaultPropertiesMixin) {
    return declare("dojox.dgauges.components.green.SemiCircularLinearGauge", [CircularGauge, DefaultPropertiesMixin], {borderColor:[50, 50, 50], fillColor:[109, 183, 19], indicatorColor:[0, 0, 0], constructor:function () {
        var scaler = new LinearScaler({majorTickInterval:25, minorTickInterval:5});
        ...
        scale.set("font", {family:"Helvetica", weight:"bold", size:"10pt"});
