...
define("dojox/form/MultiComboBox", ["dojo/_base/kernel", "dijit/form/ValidationTextBox", "dijit/form/ComboBoxMixin", "dojo/_base/declare"], function (kernel, ValidationTextBox, ComboBoxMixin, declare) {
    kernel.experimental("dojox.form.MultiComboBox");
    return declare("dojox.form.MultiComboBox", [ValidationTextBox, ComboBoxMixin], {delimiter:",", _previousMatches:false, _setValueAttr:function (value) {
