...
define("dojox/form/FilePickerTextBox", ["dojo/_base/lang", "dojo/_base/array", "dojo/_base/event", "dojo/window", "dijit/focus", "dijit/registry", "dijit/form/_TextBoxMixin", "dijit/form/ValidationTextBox", "dijit/_HasDropDown", "dojox/widget/FilePicker", "dojo/text!./resources/FilePickerTextBox.html", "dojo/_base/declare", "dojo/keys"], function (lang, array, event, windowUtils, focus, registry, _TextBoxMixin, ValidationTextBox, _HasDropDown, FilePicker, template, declare, keys) {
    return declare("dojox.form.FilePickerTextBox", [ValidationTextBox, _HasDropDown], {baseClass:"dojoxFilePickerTextBox", templateString:template, searchDelay:500, valueItem:null, numPanes:2.25, postMixInProperties:function () {
        ...
        if ((c == keys.BACKSPACE || c == keys.DELETE) && this._hasSelection) {
            ...
            if (c == keys.BACKSPACE || c == keys.DELETE || c == " ") {
                doSearch = true;
            } else {
                doSearch = e.keyChar !== "";
            }
