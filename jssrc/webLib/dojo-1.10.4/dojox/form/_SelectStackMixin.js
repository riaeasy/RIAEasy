...
define("dojox/form/_SelectStackMixin", ["dojo/_base/lang", "dojo/_base/array", "dijit/_base/manager", "dojo/_base/connect", "dojo/_base/declare"], function (lang, array, manager, connect, declare) {
    return declare("dojox.form._SelectStackMixin", null, {stackId:"", stackPrefix:"", _paneIdFromOption:function (oVal) {
        return (this.stackPrefix || "") + oVal;
        ...
        return id;
    }, _togglePane:function (pane, shown) {
        if (pane._shown != undefined && pane._shown == shown) {
            return;
        }
        ...
        pane._shown = shown;
    }, _connectTitle:function (pane, value) {
    ...
    }, onAddChild:function (pane, insertIndex) {
        ...
        this.inherited(arguments);
        this._panes = {};
        this._subscriptions = [connect.subscribe(this.stackId + "-startup", this, "onStartup"), connect.subscribe(this.stackId + "-addChild", this, "onAddChild"), connect.subscribe(this.stackId + "-removeChild", this, "onRemoveChild"), connect.subscribe(this.stackId + "-selectChild", this, "onSelectChild")];
        var stack = manager.byId(this.stackId);
