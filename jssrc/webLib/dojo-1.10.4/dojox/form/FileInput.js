...
define("dojox/form/FileInput", ["dojo/_base/declare", "dojo/_base/kernel", "dojo/_base/fx", "dojo/dom-attr", "dojo/dom-class", "dojo/text!./resources/FileInput.html", "dijit/form/_FormWidget", "dijit/_Templated"], function (declare, kernel, fx, domAttr, domClass, template, FormWidget, Templated) {
    kernel.experimental("dojox.form.FileInput");
    return declare("dojox.form.FileInput", FormWidget, {label:"Browse ...", cancelText:"Cancel", name:"uploadFile", templateString:template, startup:function () {
    ...
    }, setLabel:function (label, cssClass) {
