...
define("dojox/av/widget/Status", ["dojo", "dijit", "dijit/_Widget", "dijit/_TemplatedMixin"], function (dojo, dijit, _Widget, _TemplatedMixin) {
    return dojo.declare("dojox.av.widget.Status", [_Widget, _TemplatedMixin], {templateString:dojo.cache("dojox.av.widget", "resources/Status.html"), setMedia:function (med) {
        this.media = med;
