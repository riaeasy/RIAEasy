...
define("dojox/grid/_Selector", ["../main", "dojo/_base/declare", "dojo/_base/lang", "dojo/query", "dojo/dom-class", "./Selection", "./_View", "./_Builder", "./util"], function (dojox, declare, lang, query, domClass, Selection, _View, _Builder, util) {
    var _InputSelectorHeaderBuilder = dojox.grid._InputSelectorHeaderBuilder = lang.extend(function (view) {
    ...
    }, _Builder._HeaderBuilder.prototype, {generateHtml:function () {
        ...
        return "<table style=\"width:" + w + "px;\" " + "border=\"0\" cellspacing=\"0\" cellpadding=\"0\" " + "role=\"presentation\"><tr><th style=\"text-align: center;\">" + "<div class=\"dojoxGridCheckSelector dijitReset dijitInline dijitCheckBox" + checked + "\"></div></th></tr></table>";
    }, doclick:function (e) {
        var selectedCount = this.view.grid.selection.getSelectedCount();
    ...
    }, _Builder._ContentBuilder.prototype, {generateHtml:function (inDataIndex, inRowIndex) {
        var w = this.view.contentWidth || 0;
        return "<table class=\"dojoxGridRowbarTable\" style=\"width:" + w + "px;\" border=\"0\" " + "cellspacing=\"0\" cellpadding=\"0\" role=\"presentation\"><tr>" + "<td  style=\"text-align: center;\" class=\"dojoxGridRowbarInner\">" + this.getCellContent(inRowIndex) + "</td></tr></table>";
    ...
    }, _SelectorContentBuilder.prototype, {getCellContent:function (rowIndex) {
        var v = this.view;
    ...
    var _Selector = declare("dojox.grid._Selector", _View, {inputType:"", selectionMode:"", defaultWidth:"2em", noscroll:true, padBorderWidth:2, _contentBuilderClass:_SelectorContentBuilder, postCreate:function () {
    ...
    if (!_View.prototype._headerBuilderClass && !_View.prototype._contentBuilderClass) {
    ...
    declare("dojox.grid._RadioSelector", _Selector, {inputType:"radio", selectionMode:"single", _contentBuilderClass:_InputSelectorContentBuilder, buildRendering:function () {
        this.inherited(arguments);
        this.headerNode.style.visibility = "hidden";
    }, renderHeader:function () {
    }});
    declare("dojox.grid._CheckBoxSelector", _Selector, {inputType:"checkbox", _headerBuilderClass:_InputSelectorHeaderBuilder, _contentBuilderClass:_InputSelectorContentBuilder, postCreate:function () {
        this.inherited(arguments);
