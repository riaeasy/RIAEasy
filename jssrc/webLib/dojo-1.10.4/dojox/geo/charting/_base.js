...
define("dojox/geo/charting/_base", ["dojo/_base/lang", "dojo/_base/array", "../../main", "dojo/_base/html", "dojo/dom-geometry", "dojox/gfx/matrix", "dijit/Tooltip", "dojo/_base/NodeList", "dojo/NodeList-traverse"], function (lang, arr, dojox, html, domGeom, matrix, Tooltip, NodeList, NodeListTraverse) {
    var dgc = lang.getObject("geo.charting", true, dojox);
    dgc.showTooltip = function (innerHTML, gfxObject, positions) {
        var arroundNode = dgc._normalizeArround(gfxObject);
        return Tooltip.show(innerHTML, arroundNode, positions);
    };
    dgc.hideTooltip = function (gfxObject) {
    ...
    dgc._normalizeArround = function (gfxObject) {
        ...
        gfxObject.x = domGeom.position(gfxDomContainer, true).x + point.x, gfxObject.y = domGeom.position(gfxDomContainer, true).y + point.y, gfxObject.w = bbox.width * realMatrix.xx, gfxObject.h = bbox.height * realMatrix.yy;
        return gfxObject;
    };
