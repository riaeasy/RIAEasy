...
define("dojox/treemap/ScaledLabel", ["dojo/_base/declare", "dojo/dom-geometry", "dojo/dom-construct", "dojo/dom-style"], function (declare, domGeom, domConstruct, domStyle) {
    return declare("dojox.treemap.ScaledLabel", null, {onRendererUpdated:function (evt) {
        if (evt.kind == "leaf") {
        ...
        if (kind == "leaf") {
            ...
            domStyle.set(p, {"position":"absolute", "width":"auto"});
