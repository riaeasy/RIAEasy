...
define("dojox/lang/docs", ["dijit", "dojo", "dojox"], function (dijit, dojo, dojox) {
    ...
    (function () {
        function error(error) {
            console.log("Warning, the API docs must be available at ../util/docscripts/api.json " + "or ../util/docscripts/api/*.json " + "in order for dojox.lang.docs to supply schema information, but it could not be loaded: " + error);
        }
        var declaredClasses = {};
        var requiredModules = [];
        ...
        var getType = function (typeDef) {
            ...
            if (type.match(/HTML/)) {
                ...
                if (type == "String" || type == "Number" || type == "Boolean" || type == "Object" || type == "Array" || type == "Integer" || type == "Function") {
        ...
        dojox.lang.docs.init = function (async) {
            function loadFullDocs() {
                ...
                try {
                    dojo.xhrGet({sync:!async, url:dojo.baseUrl + "../util/docscripts/api.json", handleAs:"text"}).addCallbacks(function (obj) {
            ...
            var getSplitDocs = function (moduleName, sync) {
                return dojo.xhrGet({sync:sync || !async, url:dojo.baseUrl + "../util/docscripts/api/" + moduleName + ".json", handleAs:"text"}).addCallback(function (obj) {
