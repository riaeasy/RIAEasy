...
define("dojox/charting/action2d/MoveSlice", ["dojo/_base/connect", "dojo/_base/declare", "dojo/_base/array", "./PlotAction", "dojo/fx/easing", "dojox/gfx/matrix", "dojox/gfx/fx", "dojox/lang/functional", "dojox/lang/functional/scan", "dojox/lang/functional/fold"], function (hub, declare, array, PlotAction, dfe, m, gf, df) {
    var DEFAULT_SCALE = 1.05, DEFAULT_SHIFT = 7;
    return declare("dojox.charting.action2d.MoveSlice", PlotAction, {defaultParams:{duration:400, easing:dfe.backOut, scale:DEFAULT_SCALE, shift:DEFAULT_SHIFT}, optionalParams:{}, constructor:function (chart, plot, kwArgs) {
        if (!kwArgs) {
            kwArgs = {};
        }
        ...
        anim.action = gf.animateTransform({shape:o.shape, duration:this.duration, easing:this.easing, transform:[rotateBack, {name:"translate", start:[startOffset, 0], end:[endOffset, 0]}, {name:"scaleAt", start:[startScale, o.cx, o.cy], end:[endScale, o.cx, o.cy]}, rotateTo0]});
