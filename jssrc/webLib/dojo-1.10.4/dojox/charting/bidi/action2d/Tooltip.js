...
define("dojox/charting/bidi/action2d/Tooltip", ["dojo/_base/declare", "dojo/dom-style"], function (declare, domStyle) {
    return declare(null, {_recheckPosition:function (obj, rect, position) {
        ...
        if (obj.element == "marker") {
            ...
            if (obj.element == "circle") {
                ...
                if (obj.element == "bar" || obj.element == "column") {
