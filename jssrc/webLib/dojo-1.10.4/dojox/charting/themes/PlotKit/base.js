    ...
    pk.base.next = function (elementType, mixin, doPost) {
        ...
        if (elementType == "line") {
            ...
            if (elementType == "candlestick") {
                ...
                if (theme.series.stroke.color && (theme.series.stroke.color.toString() == new Color(this.colors[(this._current - 1) % this.colors.length]).toString())) {
