...
define("dojox/charting/widget/SelectableLegend", ["dojo/_base/array", "dojo/_base/declare", "dojo/query", "dojo/_base/connect", "dojo/_base/Color", "./Legend", "dijit/form/CheckBox", "../action2d/Highlight", "dojox/lang/functional", "dojox/gfx/fx", "dojo/keys", "dojo/dom-construct", "dojo/dom-prop", "dijit/registry"], function (arrayUtil, declare, query, hub, Color, Legend, CheckBox, Highlight, df, fx, keys, dom, domProp, registry) {
    var FocusManager = declare(null, {constructor:function (legend) {
        this.legend = legend;
        this.index = 0;
        ...
        hub.connect(this.firstLabel, "focus", this, function () {
    ...
    var FakeHighlight = declare(Highlight, {connect:function () {
    }});
    var SelectableLegend = declare("dojox.charting.widget.SelectableLegend", Legend, {outline:false, transitionFill:null, transitionStroke:null, autoScale:false, postCreate:function () {
        this.legends = [];
        this.legendAnim = {};
        this._cbs = [];
        ...
        arrayUtil.forEach(this.legends, function (legend, i) {
            ...
            var legendIcon = query(".dojoxLegendIcon", legend)[0], iconShape = this._getFilledShape(this._surfaces[i].children);
