...
define("dojox/dtl/tag/loader", ["dojo/_base/lang", "../_base", "dojo/_base/array", "dojo/_base/connect"], function (lang, dd, array, connect) {
    ...
    ddtl.ExtendsNode = lang.extend(function (getTemplate, nodelist, shared, parent, key) {
        ...
        this.parent = parent;
        this.key = key;
    }, {parents:{}, getParent:function (context) {
        ...
        for (var i = 0, node; node = this.nodelist.contents[i]; i++) {
            if (node instanceof dojox.dtl.tag.loader.BlockNode) {
                ...
                parent.blocks[node.name] = buffer.blocks[node.name] = {shared:this.shared, nodelist:node.nodelist, used:false};
            }
        }
    ...
    }, {_cache:[{}, {}], render:function (context, buffer) {
    ...
    lang.mixin(ddtl, {block:function (parser, token) {
