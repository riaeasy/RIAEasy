...
define("dojox/dtl/tag/misc", ["dojo/_base/lang", "dojo/_base/array", "dojo/_base/connect", "../_base"], function (lang, array, connect, dd) {
    ...
    ddtm.SpacelessNode = lang.extend(function (nodelist, text) {
        ...
        if (buffer.getParent) {
            var watch = [connect.connect(buffer, "onAddNodeComplete", this, "_watch"), connect.connect(buffer, "onSetParent", this, "_watchParent")];
    ...
    lang.mixin(ddtm, {comment:function (parser, token) {
