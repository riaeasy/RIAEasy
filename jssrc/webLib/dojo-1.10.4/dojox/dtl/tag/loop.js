...
define("dojox/dtl/tag/loop", ["dojo/_base/lang", "dojo/_base/array", "dojo/_base/json", "../_base", "dojox/string/tokenize"], function (lang, array, json, dd, Tokenize) {
    ...
    lang.mixin(ddtl, {cycle:function (parser, token) {
