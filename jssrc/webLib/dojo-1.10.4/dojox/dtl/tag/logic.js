...
define("dojox/dtl/tag/logic", ["dojo/_base/lang", "../_base"], function (lang, dd) {
    ...
    ddtl.ForNode = lang.extend(function (assign, loop, reversed, nodelist) {
        ...
        var forloop = context.forloop = {parentloop:context.get("forloop", {})};
        var j = 0;
    ...
    lang.mixin(ddtl, {if_:function (parser, token) {
