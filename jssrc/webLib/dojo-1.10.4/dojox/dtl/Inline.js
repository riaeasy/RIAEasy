...
define("dojox/dtl/Inline", ["dojo/_base/lang", "./_base", "dijit/_WidgetBase", "dojo/query"], function (lang, dd, Widget, Query) {
    return dd.Inline = lang.extend(function (args, node) {
        this.create(args, node);
    }, Widget.prototype, {context:null, render:function (context) {
