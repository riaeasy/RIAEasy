...
define("dojox/dtl/contrib/dijit", ["dojo/_base/lang", "dojo/_base/connect", "dojo/_base/array", "dojo/query", "../_base", "../dom", "dojo/parser", "dojo/_base/sniff"], function (lang, connect, array, query, dd, dxdom, parser, has) {
    ...
    ddcd.EventNode = lang.extend(function (command, obj) {
        ...
        this._object = obj;
        this._rendered = [];
    }, {_clear:false, render:function (context, buffer) {
    ...
    lang.mixin(ddcd, {widgetsInTemplate:true, dojoAttachPoint:function (parser, token) {
