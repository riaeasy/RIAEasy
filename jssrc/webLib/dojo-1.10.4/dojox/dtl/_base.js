...
define("dojox/dtl/_base", ["dojo/_base/kernel", "dojo/_base/lang", "dojox/string/tokenize", "dojo/_base/json", "dojo/dom", "dojo/_base/xhr", "dojox/string/Builder", "dojo/_base/Deferred"], function (kernel, lang, Tokenize, json, dom, xhr, StringBuilder, deferred) {
    ...
    var split_re = /\s+/g;
    var split = function (splitter, limit) {
    ...
    var ddt = dd.text = {_get:function (module, name, errorless) {
        ...
        if (sync) {
            ...
            return xhr.get({handleAs:json ? "json" : "text", url:location});
        }
    ...
    dd.Template = lang.extend(function (template, isString) {
    ...
    dd._NodeList = lang.extend(function (nodes) {
        this.contents = nodes || [];
        this.last = "";
    }, {push:function (node) {
    ...
    dd.register = {_registry:{attributes:[], tags:[], filters:[]}, get:function (module, name) {
    ...
    }, tags:function (base, locations) {
        dd.register._any("tags", base, locations);
    }, filters:function (base, locations) {
