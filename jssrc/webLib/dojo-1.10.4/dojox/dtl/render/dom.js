...
define("dojox/dtl/render/dom", ["dojo/_base/lang", "dojo/dom", "../Context", "../dom", "../_base"], function (lang, dom, ddc, dddom, dd) {
    var ddrd = lang.getObject("render.dom", true, dd);
    ddrd.Render = function (attachPoint, tpl) {
        this._tpl = tpl;
        this.domNode = dom.byId(attachPoint);
    };
    lang.extend(ddrd.Render, {setAttachPoint:function (node) {
        this.domNode = node;
    }, render:function (context, tpl, buffer) {
        if (!this.domNode) {
