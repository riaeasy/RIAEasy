...
define("dojox/dtl/filter/strings", ["dojo/_base/lang", "dojo/_base/array", "dojox/string/tokenize", "dojox/string/sprintf", "../filter/htmlstrings", "../_base"], function (lang, array, Tokenize, Sprintf, htmlstrings, dd) {
    var strings = lang.getObject("filter.strings", true, dd);
    lang.mixin(strings, {_urlquote:function (url, safe) {
        if (!safe) {
            safe = "/";
        }
        ...
        return Tokenize(value, /(\S+)/g, function (word) {
            ...
            if (startsWww || (!hasAt && !startsHttp && middle.length && firstAlpha && (last4 == ".org" || last4 == ".net" || last4 == ".com"))) {
                ...
                if (startsHttp || startsHttps) {
                    ...
                    if (hasAt && !startsWww && !hasColon && strings._urlize2.test(middle)) {
