...
define("dojox/gantt/TabMenu", ["./contextMenuTab", "./GanttTaskControl", "./GanttProjectControl", "dijit/Dialog", "dijit/form/Button", "dijit/form/Form", "dijit/registry", "dojo/_base/declare", "dojo/_base/array", "dojo/_base/lang", "dojo/date/locale", "dojo/request", "dojo/on", "dojo/dom", "dojo/dom-class", "dojo/dom-construct", "dojo/dom-style", "dojo/dom-attr", "dojo/dom-geometry", "dojo/keys", "dojo/domReady!"], function (contextMenuTab, GanttTaskControl, GanttProjectControl, Dialog, Button, Form, registry, declare, arrayUtil, lang, locale, request, on, dom, domClass, domConstruct, domStyle, domAttr, domGeometry, keys) {
    return declare("dojox.gantt.TabMenu", [], {constructor:function (chart) {
        ...
        this.menuPanel = domConstruct.create("div", {innerHTML:"<table></table>", className:"ganttMenuPanel"}, this.ganttChart.content);
        ...
        this.tabPanelDlg = registry.byId(this.tabPanelDlgId) || new Dialog({title:"Settings"});
        ...
        var cell = domConstruct.create("td", {className:"ganttContextMenuItem", innerHTML:tab.Description});
        domAttr.set(cell, "tabIndex", 0);
        this.ganttChart._events.push(on(cell, "click", lang.hitch(this, function () {
            try {
                this.hide();
                tab.show();
            }
        ...
        this.ganttChart._events.push(on(cell, "keydown", lang.hitch(this, function (event) {
        ...
        this.ganttChart._events.push(on(cell, "mouseover", lang.hitch(this, function () {
            domClass.add(cell, "ganttContextMenuItemHover");
        })));
        this.ganttChart._events.push(on(cell, "mouseout", lang.hitch(this, function () {
        ...
        if (object.constructor == GanttTaskControl) {
            ...
            if (object.constructor == GanttProjectControl) {
                arrayUtil.forEach(this.arrTabs, function (tab) {
                    if (tab.type == "p") {
                        tab.object = object;
                        this.addItemMenuPanel(tab);
        ...
        this.isShow = true;
        domStyle.set(this.menuPanel, {zIndex:15, visibility:"visible"});
        var menuBox = domGeometry.position(this.menuPanel, true), bBox = domGeometry.position(this.ganttChart.content, true), pos = domGeometry.position(elem, true);
