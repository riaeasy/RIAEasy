...
define("dojox/gantt/GanttTaskControl", ["dijit/focus", "dojo/_base/declare", "dojo/_base/array", "dojo/_base/lang", "dojo/date/locale", "dojo/request", "dojo/on", "dojo/dom", "dojo/dom-class", "dojo/dom-construct", "dojo/dom-style", "dojo/dom-attr", "dojo/dom-geometry", "dojo/keys", "dojo/domReady!"], function (focus, declare, arrayUtil, lang, locale, request, on, dom, domClass, domConstruct, domStyle, domAttr, domGeometry, keys) {
    return declare("dojox.gantt.GanttTaskControl", [], {constructor:function (taskInfo, project, chart) {
        ...
        var lineVerticalLeft = domConstruct.create("div", {innerHTML:"&nbsp;", className:"ganttTaskLineVerticalLeft"}, this.ganttChart.panelNames.firstChild);
        var cTaskName = this.cTaskNameItem[0], pcTaskName = this.parentTask.cTaskNameItem[0];
        domStyle.set(lineVerticalLeft, {height:(cTaskName.offsetTop - pcTaskName.offsetTop) + "px", top:(pcTaskName.offsetTop + 5) + "px", left:(pcTaskName.offsetLeft - 9) + "px"});
        var LineHorizontalLeft = domConstruct.create("div", {noShade:true, color:"#000000", className:"ganttTaskLineHorizontalLeft"}, this.ganttChart.panelNames.firstChild);
        domStyle.set(LineHorizontalLeft, {left:(pcTaskName.offsetLeft - 9) + "px", top:(cTaskName.offsetTop + 5) + "px", height:"1px", width:(cTaskName.offsetLeft - pcTaskName.offsetLeft + 4) + "px"});
        ...
        var arrLines = [];
        var arrowImg = domConstruct.create("div", {className:"ganttImageArrow"});
        ...
        if (posYPreviousTask < posYChildTask) {
            ...
            domStyle.set(lineVerticalRight, {height:(posYChildTask - this.ganttChart.heightTaskItem / 2 - posYPreviousTask - 3) + "px", width:"1px", left:(posXPreviousTask + widthPreviousTask - 20) + "px", top:(posYPreviousTask + this.ganttChart.heightTaskItem) + "px"});
            domClass.add(lineHorizontal, "ganttTaskLineHorizontal");
            domStyle.set(lineHorizontal, {width:(15 + (posXChildTask - (widthPreviousTask + posXPreviousTask))) + "px", left:(posXPreviousTask + widthPreviousTask - 20) + "px", top:(posYChildTask + 2) + "px"});
            domClass.add(arrowImg, "ganttTaskArrowImg");
            domStyle.set(arrowImg, {left:(posXChildTask - 7) + "px", top:(posYChildTask - 1) + "px"});
        } else {
            domClass.add(lineVerticalRight, "ganttTaskLineVerticalRightPlus");
            domStyle.set(lineVerticalRight, {height:(posYPreviousTask + 2 - posYChildTask) + "px", width:"1px", left:(posXPreviousTask + widthPreviousTask - 20) + "px", top:(posYChildTask + 2) + "px"});
        ...
        if (isOpen) {
            for (var i = 0; i < task.childTask.length; i++) {
                var cTask = task.childTask[i], cTaskItem0 = cTask.cTaskItem[0], cTaskName0 = cTask.cTaskNameItem[0], cTaskItem1 = cTask.cTaskItem[1], cTaskName1 = cTask.cTaskNameItem[1], cTaskName2 = cTask.cTaskNameItem[2];
        ...
        var taskItem0 = task.cTaskItem[0], taskName0 = task.cTaskNameItem[0], taskItem1 = task.cTaskItem[1], taskName1 = task.cTaskNameItem[1], taskName2 = task.cTaskNameItem[2];
        taskName0.style.top = parseInt(taskName0.style.top) + height + "px";
        if (taskName2) {
            taskName2.style.top = parseInt(taskName2.style.top) + height + "px";
        }
        if (task.parentTask) {
            if (parseInt(this.cTaskNameItem[0].style.top) > parseInt(task.parentTask.cTaskNameItem[0].style.top) && (taskName1[0].style.display != "none")) {
        ...
        if (task.predTask) {
            if (((parseInt(this.cTaskItem[0].style.top) > parseInt(task.predTask.cTaskItem[0].style.top)) || (this.cTaskItem[0].id == task.predTask.taskItem.id)) && taskItem1[0].style.display != "none") {
        ...
        if (this.checkResize) {
            ...
            if (widthTaskItem >= this.taskItemWidth) {
                if ((widthTaskItem <= this.maxWidthResize) || (this.maxWidthResize == -1)) {
                    ...
                    if ((this.maxWidthResize != -1) && (widthTaskItem > this.maxWidthResize)) {
        ...
        var trow = taskItem.childNodes[0].firstChild.rows[0], rc0 = trow.cells[0], rc1 = trow.cells[1];
        ...
        if ((this.taskItemWidth != parseInt(taskItem.childNodes[0].firstChild.width))) {
            ...
            if (this.childPredTask.length > 0) {
                for (var j = 0; j < this.childPredTask.length; j++) {
                    var cpctItem = this.childPredTask[j].cTaskItem[1], item0 = cpctItem[0], item2 = cpctItem[2], tcNode0 = taskItem.childNodes[0];
        ...
        var itemControl = domConstruct.create("div", {id:this.taskItem.id, className:"ganttTaskItemControl"});
        domStyle.set(itemControl, {left:this.posX + "px", top:this.posY + "px"});
        var divTaskItem = domConstruct.create("div", {className:"ganttTaskDivTaskItem"}, itemControl);
        var tblTaskItem = domConstruct.create("table", {cellPadding:"0", cellSpacing:"0", width:this.taskItem.duration * this.ganttChart.pixelsPerWorkHour + "px", className:"ganttTaskTblTaskItem"}, divTaskItem);
        var rowTblTask = tblTaskItem.insertRow(tblTaskItem.rows.length);
        if (this.taskItem.percentage != 0) {
            var cellTblTask = domConstruct.create("td", {height:this.ganttChart.heightTaskItem + "px", width:this.taskItem.percentage + "%"}, rowTblTask);
            cellTblTask.style.lineHeight = "1px";
            var imageProgress = domConstruct.create("div", {className:"ganttImageTaskProgressFilled"}, cellTblTask);
            domStyle.set(imageProgress, {width:(this.taskItem.percentage * this.taskItem.duration * this.ganttChart.pixelsPerWorkHour) / 100 + "px", height:this.ganttChart.heightTaskItem + "px"});
        }
        if (this.taskItem.percentage != 100) {
            var cellTblTask = domConstruct.create("td", {height:this.ganttChart.heightTaskItem + "px", width:(100 - this.taskItem.percentage) + "%"}, rowTblTask);
            cellTblTask.style.lineHeight = "1px";
            var imageProgressFill = domConstruct.create("div", {className:"ganttImageTaskProgressBg"}, cellTblTask);
            domStyle.set(imageProgressFill, {width:((100 - this.taskItem.percentage) * this.taskItem.duration * this.ganttChart.pixelsPerWorkHour) / 100 + "px", height:this.ganttChart.heightTaskItem + "px"});
        }
        if (this.ganttChart.isContentEditable) {
            var divTaskInfo = domConstruct.create("div", {className:"ganttTaskDivTaskInfo"}, itemControl);
            var tblTaskInfo = domConstruct.create("table", {cellPadding:"0", cellSpacing:"0", height:this.ganttChart.heightTaskItem + "px", width:this.taskItem.duration * this.ganttChart.pixelsPerWorkHour + "px"}, divTaskInfo);
            var rowTaskInfo = tblTaskInfo.insertRow(0);
            var cellTaskInfo = domConstruct.create("td", {align:"center", vAlign:"top", height:this.ganttChart.heightTaskItem + "px", className:"ganttMoveInfo"}, rowTaskInfo);
            ...
            domConstruct.create("input", {className:"ganttTaskDivMoveInput", type:"text"}, divMove);
            domStyle.set(divMove, {background:"#000000", opacity:0});
            domStyle.set(divMove, {height:this.ganttChart.heightTaskItem + "px", width:this.taskItem.duration * this.ganttChart.pixelsPerWorkHour + "px"});
            var divResize = domConstruct.create("div", {className:"ganttTaskDivResize"}, divTaskName);
            domConstruct.create("input", {className:"ganttTaskDivResizeInput", type:"text"}, divResize);
            domStyle.set(divResize, {left:(this.taskItem.duration * this.ganttChart.pixelsPerWorkHour - 10) + "px", height:this.ganttChart.heightTaskItem + "px", width:"10px"});
            this.ganttChart._events.push(on(divMove, "mousedown", lang.hitch(this, function (event) {
            ...
            this.ganttChart._events.push(on(divMove, "mouseover", lang.hitch(this, function (event) {
                event.target && (event.target.style.cursor = "move");
            })));
            this.ganttChart._events.push(on(divMove, "mouseout", lang.hitch(this, function (event) {
                event.target.style.cursor = "";
            })));
            this.ganttChart._events.push(on(divResize, "mousedown", lang.hitch(this, function (event) {
            ...
            this.ganttChart._events.push(on(divResize, "mouseover", lang.hitch(this, function (event) {
                (!this.ganttChart.isMoving) && (!this.ganttChart.isResizing) && event.target && (event.target.style.cursor = "e-resize");
            })));
            this.ganttChart._events.push(on(divResize, "mouseout", lang.hitch(this, function (event) {
                !this.checkResize && event.target && (event.target.style.cursor = "");
            })));
        }
        return itemControl;
    }, createTaskNameItem:function () {
        var divName = domConstruct.create("div", {id:this.taskItem.id, className:"ganttTaskTaskNameItem", title:this.taskItem.name + ", id: " + this.taskItem.id + " ", innerHTML:this.taskItem.name});
        domStyle.set(divName, "top", this.posY + "px");
        domAttr.set(divName, "tabIndex", 0);
        if (this.ganttChart.isShowConMenu) {
            this.ganttChart._events.push(on(divName, "mouseover", lang.hitch(this, function (event) {
            ...
            this.ganttChart._events.push(on(divName, "keydown", lang.hitch(this, function (event) {
            ...
            this.ganttChart._events.push(on(divName, "mouseout", lang.hitch(this, function () {
            ...
            this.ganttChart._events.push(on(this.ganttChart.tabMenu.menuPanel, "mouseover", lang.hitch(this, function () {
                clearTimeout(this.ganttChart.menuTimer);
            })));
            this.ganttChart._events.push(on(this.ganttChart.tabMenu.menuPanel, "keydown", lang.hitch(this, function (event) {
                if (this.ganttChart.tabMenu.isShow && event.keyCode == keys.ESCAPE) {
                    this.ganttChart.tabMenu.hide();
                }
            })));
            this.ganttChart._events.push(on(this.ganttChart.tabMenu.menuPanel, "mouseout", lang.hitch(this, function () {
                clearTimeout(this.ganttChart.menuTimer);
                this.ganttChart.menuTimer = setTimeout(lang.hitch(this, function () {
                    this.ganttChart.tabMenu.hide();
                }), 200);
        ...
        var divDesc = domConstruct.create("div", {innerHTML:this.objKeyToStr(this.getTaskOwner()), className:"ganttTaskDescTask"});
        domStyle.set(divDesc, {left:posX + "px", top:this.posY + "px"});
        ...
        this.posX = this.ganttChart.getPosOnDate(this.taskItem.startTime);
        domStyle.set(itemControl, {"left":this.posX + "px"});
        ...
        if (this.taskItem.percentage != 0) {
            ...
            domStyle.set(imageProgress, {width:(!this.taskItem.duration ? 1 : (this.taskItem.percentage * this.taskItem.duration * this.ganttChart.pixelsPerWorkHour / 100)) + "px", height:this.ganttChart.heightTaskItem + "px"});
        }
        if (this.taskItem.percentage != 100) {
            ...
            domStyle.set(imageProgressFill, {width:(!this.taskItem.duration ? 1 : ((100 - this.taskItem.percentage) * this.taskItem.duration * this.ganttChart.pixelsPerWorkHour / 100)) + "px", height:this.ganttChart.heightTaskItem + "px"});
        }
        if (this.ganttChart.isContentEditable) {
            ...
            domStyle.set(divResize, {"left":(this.taskItem.duration * this.ganttChart.pixelsPerWorkHour - 10) + "px"});
        ...
        var posX = (this.posX + this.taskItem.duration * this.ganttChart.pixelsPerWorkHour + 10);
        domStyle.set(divDesc, {"left":posX + "px"});
        return divDesc;
        ...
        var widthPreviousTask = parseInt(this.predTask.cTaskItem[0].firstChild.firstChild.width);
        if (posYPreviousTask < posYChildTask) {
            domStyle.set(lineVerticalRight, {"height":(posYChildTask - this.ganttChart.heightTaskItem / 2 - posYPreviousTask - 3) + "px", "left":(posXPreviousTask + widthPreviousTask - 20) + "px"});
            domStyle.set(lineHorizontal, {"width":(15 + (posXChildTask - (widthPreviousTask + posXPreviousTask))) + "px", "left":(posXPreviousTask + widthPreviousTask - 20) + "px"});
            domStyle.set(arrowImg, {"left":(posXChildTask - 7) + "px"});
        } else {
            domStyle.set(lineVerticalRight, {"height":(posYPreviousTask + 2 - posYChildTask) + "px", "left":(posXPreviousTask + widthPreviousTask - 20) + "px"});
            domStyle.set(lineHorizontal, {"width":(15 + (posXChildTask - (widthPreviousTask + posXPreviousTask))) + "px", "left":(posXPreviousTask + widthPreviousTask - 20) + "px"});
            domStyle.set(arrowImg, {"left":(posXChildTask - 7) + "px"});
        }
        return arrLines;
        ...
        if (parentTask) {
            ...
            if (this.taskItem.previousChildTask) {
                ...
                this.posY = domStyle.get(lastChildTask.cTaskItem[0], "top") + this.ganttChart.heightTaskItem + this.ganttChart.heightTaskItemExtra;
                this.previousChildTask.nextChildTask = this;
            } else {
                this.posY = domStyle.get(task.cTaskItem[0], "top") + this.ganttChart.heightTaskItem + this.ganttChart.heightTaskItemExtra;
            }
        ...
        if (this.taskIdentifier) {
            ...
            domStyle.set(this.taskIdentifier, {"left":(pos.l + pos.w + 4) + "px", "top":(pos.t - 1) + "px"});
        } else {
            this.taskIdentifier = domConstruct.create("div", {id:"TaskId_" + this.taskItem.id, className:"ganttTaskIdentifier", title:this.taskItem.id, innerHTML:this.taskItem.id}, this.cTaskNameItem[0].parentNode);
            domStyle.set(this.taskIdentifier, {left:(pos.l + pos.w + 4) + "px", top:(pos.t - 1) + "px"});
        }
    }, createTreeImg:function () {
        var treeImg = domConstruct.create("div", {id:this.taskItem.id, className:"ganttImageTreeCollapse"});
        domAttr.set(treeImg, "tabIndex", 0);
        arrayUtil.forEach(["click", "keydown"], function (e) {
            this.ganttChart._events.push(on(treeImg, e, lang.hitch(this, function (evt) {
                if (e == "keydown" && evt.keyCode != keys.ENTER) {
                    return;
                }
                if (this.isExpanded) {
        ...
        domStyle.set(treeImg, {left:(domStyle.get(this.cTaskNameItem[0], "left") - 12) + "px", top:(domStyle.get(this.cTaskNameItem[0], "top") + 3) + "px"});
        return treeImg;
        ...
        if (previousTaskId == "") {
            ...
            var startTime = task.startTime.getTime(), pest = predTask.startTime.getTime(), pdur = predTask.duration * 24 * 60 * 60 * 1000 / predTaskObj.ganttChart.hsPerDay;
        ...
        var trow = this.cTaskItem[0].childNodes[0].firstChild.rows[0], rc0 = trow.cells[0], rc1 = trow.cells[1];
        if ((percentage != 0) && (percentage != 100)) {
            if ((this.taskItem.percentage != 0) && (this.taskItem.percentage != 100)) {
                ...
                if ((this.taskItem.percentage == 0) || (this.taskItem.percentage == 100)) {
                    ...
                    var cellTblTask = domConstruct.create("td", {height:this.ganttChart.heightTaskItem + "px", width:percentage + "%"}, trow);
                    cellTblTask.style.lineHeight = "1px";
                    var imageProgressFill = domConstruct.create("div", {className:"ganttImageTaskProgressFilled"}, cellTblTask);
                    domStyle.set(imageProgressFill, {width:(percentage * this.taskItem.duration * this.ganttChart.pixelsPerWorkHour) / 100 + "px", height:this.ganttChart.heightTaskItem + "px"});
                    cellTblTask = domConstruct.create("td", {height:this.ganttChart.heightTaskItem + "px", width:(100 - percentage) + "%"}, trow);
                    cellTblTask.style.lineHeight = "1px";
                    imageProgressFill = domConstruct.create("div", {className:"ganttImageTaskProgressBg"}, cellTblTask);
                    domStyle.set(imageProgressFill, {width:((100 - percentage) * this.taskItem.duration * this.ganttChart.pixelsPerWorkHour) / 100 + "px", height:this.ganttChart.heightTaskItem + "px"});
                }
            }
        } else {
            if (percentage == 0) {
