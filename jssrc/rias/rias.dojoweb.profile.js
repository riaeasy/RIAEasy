...
var profile = (function(){
	return {
		...
		releaseDir: "../../RSServer/jssrc/webLib/dojo-1.10.4-min",///相对于 basePath，编译目标目录，编译器会覆盖它发现的一切。
		releaseName: "",
		...
		defaultConfig: {///应用中的 html 中需要的 dojoConfig
			...
			packages: [
				...
				{name: 'rias', location: '../rias', main: 'riasw/riasw'},
				{name: 'app', location: '../app', main: 'app'},
				{name: 'appModule', location: '../appModule', main: 'appModule'}
			]
		},
