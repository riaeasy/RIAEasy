...
define([
	...
	var riaswType = "rias.riasw.form._Spinner";
	var Widget = rias.declare(riaswType, [_Widget], {
		...
		templateString:
			'<span class="dijit dijitReset dijitInline dijitLeft" id="widget_${id}" role="presentation">'+
				'<span class="riaswTextBoxLabel" data-dojo-attach-point="labelNode" tabIndex="-1" readonly="readonly" role="presentation">'+
				'</span>'+
				'<span class="dijitInputField riaswTextBoxContainer" data-dojo-attach-point="containerNode,_aroundNode">'+
					...
					'</span>'+
				'</span>'+
				'<span class="riaswSpinnerButtonContainer" data-dojo-attach-point="_buttonNode">'+
					'<span class="dijitLeft riaswArrowButton riaswUpArrowButton" data-dojo-attach-point="upArrowNode">'+
					...
					'</span>'+
					'<span class="dijitLeft riaswArrowButton riaswDownArrowButton" data-dojo-attach-point="downArrowNode">'+
						'<input class="dijitInputField riaswArrowButtonInner" type="text" tabIndex="-1" readonly="readonly" role="button presentation" aria-hidden="true"${_buttonInputDisabled}/>'+
					'</span>'+
				'</span>'+
			'</span>',
