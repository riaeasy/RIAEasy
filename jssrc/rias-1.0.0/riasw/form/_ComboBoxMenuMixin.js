define([
	...
	var ComboBoxMenuMixin = rias.declare("dijit.form._ComboBoxMenuMixin", null, {
		// summary:
		...
		postMixInProperties: function(){
			...
			this._messages = rias.i18n.getLocalization("dijit.form", "ComboBox", this.lang);
		},
		...
		createOptions: function(results, options, labelFunc){
			...
			rias.forEach(results, function(item, i){
				...
				rias.dom.setAttr(menuitem, "id", this.id + i);
