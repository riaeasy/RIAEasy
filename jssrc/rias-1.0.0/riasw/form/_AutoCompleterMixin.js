define([
	"rias",
	"rias/riasw/form/DataList",
	"rias/riasw/form/_SearchMixin"
], function(rias, DataList, SearchMixin){

	// module:
	//		rias/riasw/form/_AutoCompleterMixin

	var AutoCompleterMixin = rias.declare("rias.riasw.form._AutoCompleterMixin", SearchMixin, {
		// summary:
		...
		postCreate: function(){
			...
			this.inherited(arguments);
			rias.after(this, "onSearch", rias.hitch(this, "_openResultList"), true);
		},
