...
], function(rias, _Plugin, _Widget, _TemplatedMixin, _PaletteMixin) {

	//rias.experimental("dojox.editor.plugins.EntityPalette");
	var pluginsName = "rias.riasw.editor.htmleditor.plugins";

	var EntityPalette = rias.declare(pluginsName + ".EntityPalette", [_Widget, _TemplatedMixin, _PaletteMixin], {
		// summary:
		...
		buildRendering: function(){
			...
			var cells = rias.dom.query(".dojoxEntityPaletteCell", this.gridNode);
