define([
	...
	var PageBreak = rias.declare(pluginsName + ".PageBreak", _Plugin, {
		...
		_initButton: function(){
			...
			ed.onLoadDeferred.then(
				rias.hitch(this, function(){
					//Register our hotkey to CTRL-SHIFT-ENTER.
					ed.addKeyHandler(rias.keys.ENTER, true, true, rias.hitch(this, this._insertPageBreak));
					if(rias.has("webkit") || rias.has("opera")){
						...
						this.connect(this.editor, "onKeyDown", rias.hitch(this, function(e){
