...
define([
	...
	var riasType = "rias.riasw.mobile.ScrollableView";
	var Widget = rias.declare(riasType, [_Widget, _ScrollableMixin], {
		...
		checkFixedBar: function(/*DomNode*/node, /*Boolean*/local){
			...
			if(node.nodeType === 1){
				var w = rias.registry.byNode(node),
		...
		getChildren: function(){
			...
			if(this.fixedHeader && this.fixedHeader.parentNode === this.domNode){
				fixedWidget = rias.registry.byNode(this.fixedHeader);
				if(fixedWidget){
					children.push(fixedWidget);
				}
			}
			if(this.fixedFooter && this.fixedFooter.parentNode === this.domNode){
				fixedWidget = rias.registry.byNode(this.fixedFooter);
				if(fixedWidget){
					children.push(fixedWidget);
				}
			}
