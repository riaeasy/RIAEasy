...
define([
	...
	var riaswType = "rias.riasw.layout.Panel";
	var Widget = rias.declare(riaswType, [_PanelBase, _TemplatedMixin], {

		templateString:
			"<div role='region' data-dojo-attach-point='containerNode,focusNode' class='dijit dijitReset riaswPanelContent'>"+
			"</div>",
