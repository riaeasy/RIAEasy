...
define([
	...
	var TabControllerButtonMixin = rias.declare("rias.riasw.layout._TabControllerButtonMixin", null, {
		...
		templateString:
			'<div role="button" data-dojo-attach-point="focusNode,buttonNode" data-dojo-attach-event="ondijitclick:_onClick">' +
				...
				'<span data-dojo-attach-point="containerNode,labelNode" class="riaswButtonText"></span>' +
			'</div>',
	...
	var Widget = rias.declare(riaswType, [_WidgetsInTemplateMixin], {
		...
		buildRendering: function(){
			...
			this.inherited(arguments);
			rias.dom.addClass(this.domNode, this._baseClass0 + "-" + this.region);
		...
		_getBtnNode: function(/*Event*/ e){
			...
			var n = e.target;
			while(n && !rias.dom.containsClass(n, "riaswTabStripButton")){
				n = n.parentNode;
			}
			return n;
		},
		...
		doSlide: function(/*Number*/ direction, /*DomNode*/ node){
			...
			if(node && rias.dom.containsClass(node, "riaswTabDisabled")){
				return;
			}
