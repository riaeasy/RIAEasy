define([
	...
	var riasType = "rias.riasw.layout.ToggleSplitter";

	var Widget = rias.declare(riasType, _Splitter, {
		// summary:
		...
		postCreate: function(){
			...
			rias.dom.addClass(this.domNode, this.baseClass + rias.upperCaseFirst(region));
		},
