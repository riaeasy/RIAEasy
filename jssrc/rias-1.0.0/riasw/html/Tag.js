...
define([
	...
	var _ContentPaneResizeMixin = rias.declare("rias.riasw.layout._ContentPaneResizeMixin", null, {
		// summary:
		...
		_checkIfSingleChild: function(){
			...
			rias.dom.query("> *", this.containerNode).some(function(node){
				var widget = rias.registry.byNode(node);
			...
			rias.dom.toggleClass(this.containerNode, this.baseClass + "SingleChild", !!this._singleChild);
		},
		...
		_layoutChildren: function(){
			...
			if(this._singleChild && this._singleChild.resize){
				var cb = this._contentBox || rias.dom.getContentBox(this.containerNode);
		...
		_isShown: function(){
			...
			if(this._childOfLayoutWidget){
				...
				return (node.style.display != 'none') && (node.style.visibility != 'hidden') && !rias.dom.hasClass(node, "dijitHidden") &&
	...
	var riasType = "rias.riasw.html.Tag";
