...
define([
	...
	var riaswType = "rias.riasw.store.ObjectStore";
	return rias.declare(riaswType, [rias.Destroyable, Evented],{///因为 store 有 set 方法，故不能继承自 rias.ClassBase
		// summary:
		...
		postMixInProperties: function(){
			if(!this.ownerRiasw){
				this.ownerRiasw = this.objectStore.getOwnerRiasw() || this.objectStore._riasrOwner;
			}
		...
		save: function(kwArgs){
			...
			try{
				rias.connect(kwArgs,"onError",function(){
