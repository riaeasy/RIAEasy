...
], function(rias, _WidgetBase, _ListMouseMixin){

	// module:
	//		rias/riasw/widget/_TimePicker


	var TimePicker = rias.declare("rias.riasw.widget._TimePicker", [_WidgetBase, _ListMouseMixin], {
		// summary:
