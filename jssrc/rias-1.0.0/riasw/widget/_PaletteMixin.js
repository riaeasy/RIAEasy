define([
	...
	var PaletteMixin = rias.declare("rias.riasw.widget._PaletteMixin", _CssStateMixin, {
		// summary:
		...
		_preparePalette: function(choices, titles){
			...
			this.own(rias.on(this.gridNode, rias.a11yclick, rias.hitch(this, "_onCellClick")));
	...
	/*=====
	 PaletteMixin.__Dye = rias.declare("dijit.Dye", null, {
		 // summary:
