...
var profile = (function(){
	return {
		...
		releaseDir: "../../RSServer/jssrc/mobileLib/dojo",///相对于 basePath，编译目标目录，编译器会覆盖它发现的一切。
		releaseName: "",
		...
		defaultConfig: {///应用中的 html 中需要的 dojoConfig
			...
			packages: [
				...
				{name: 'rias', location: '../../RSServer/jssrc/rias', main: 'rias'},
				{name: 'app', location: '../../RSServer/jssrc/webContent/app', main: 'main'},
				{name: 'appModule', location: '../../RSServer/jssrc/webContent/app/module', main: 'main'}
			]
		},
