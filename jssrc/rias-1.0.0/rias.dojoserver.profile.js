...
var profile = (function(){
	return {
		...
		releaseDir: "../dojo-1.10.4-server-min",///相对于 basePath，编译目标目录，编译器会覆盖它发现的一切。
		releaseName: "",
		action: "release",
		...
		layers: {
			"dojo/dojo": {
				include: [
					...
					"rias/riass/riass",
					"rias/riass/FileMixin",
					"rias/riass/WebServer",
					"rias/riass/JettyServer",
					"rias/riasdb/DbBase",
					//"rias/riasdb/DbMySQL",
					"rias/riasd/act/deleAppModule",
					"rias/riasd/act/deleServerAct",
					"rias/riasd/act/getAppModule",
					"rias/riasd/act/getServerAct",
					"rias/riasd/act/newAppModule",
					"rias/riasd/act/newAppModuleDir",
					"rias/riasd/act/newServerAct",
					"rias/riasd/act/newServerActDir",
					"rias/riasd/act/rsfsRedo",
					"rias/riasd/act/rsfsUndo",
					"rias/riasd/act/saveAppModule",
					"rias/riasd/act/saveServerAct"*/
				],
				exclude: [
					//"rias/rias",
					//"dojo/_base/kernel",
