...
define([
	...
	var Widget = rias.declare(riaswType, [StackPanel, _TemplatedMixin], {
		...
		postMixInProperties: function(){
			...
			this.baseClass += this.tabPosition.charAt(0).toUpperCase() + this.tabPosition.substring(1).replace(/-.*/, "");
		...
		buildRendering: function(){
			...
			if(!this.doLayout){
				rias.dom.addClass(this.domNode, "riaswTabPanelNoLayout");
			}
		...
		_makeController: function(/*DomNode*/ srcNode){
			...
			var cls = this.baseClass + "-tabs" + (this.doLayout ? "" : " riaswTabNoLayout"),
