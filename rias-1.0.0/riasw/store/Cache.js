...
define([
	...
	var Cache = function(masterStore, cachingStore, options){
		options = options || {};
		return rias.delegate(masterStore, {
			...
			get: function(id, directives){
				return rias.when(cachingStore.get(id), function(result){
					return result || rias.when(masterStore.get(id, directives), function(result){
						if(result){
			...
			add: function(object, directives){
				return rias.when(masterStore.add(object, directives), function(result){
			...
			put: function(object, directives){
				...
				return rias.when(masterStore.put(object, directives), function(result){
					// now put result in cache
			...
			remove: function(id, directives){
				return rias.when(masterStore.remove(id, directives), function(result){
	...
	rias.setObject("rias.riasw.store.Cache", Cache);
