define([
	...
	var riaswType = "rias.riasw.widget.CalendarLite";
	var CalendarLite = rias.declare(riaswType, [_WidgetBase, _TemplatedMixin], {
		...
		_setValueAttr: function(/*Date|Number*/ value, /*Boolean*/ priorityChange){
			...
			if(typeof value == "string"){
				value = rias.dateStamp.fromISOString(value);
			}
		...
		_onDayClick: function(/*Event*/ evt){
			...
			if(node && !rias.dom.containsClass(node, "dijitCalendarDisabledDate")){
		...
		_markSelectedDates: function(/*Date[]*/ dates){
			...
			function mark(/*Boolean*/ selected, /*DomNode*/ cell){
				rias.dom.toggleClass(cell, "dijitCalendarSelectedDate", selected);
	...
	CalendarLite._MonthWidget = rias.declare("rias.riasw.widget.CalendarLite._MonthWidget", _WidgetBase, {
		// summary:
		...
		_setMonthAttr: function(month){
			...
			var monthNames = this.dateLocaleModule.getNames('months', 'wide', 'standAlone', this.lang, month),
				spacer =
					(rias.has("ie") == 6 ? "" : "<div class='dijitSpacer'>" +
