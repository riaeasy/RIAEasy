...
define([
	...
	var riaswType = "rias.riasw.widget.TreeModel";

	var Widget = rias.declare(riaswType, [rias.ClassBase, ForestStoreModel], {
		...
		destroy: function(){
			...
			this.inherited(arguments);
			//rias.hitch(this, rias.ClassBase.prototype.destroy)(arguments);
		},
