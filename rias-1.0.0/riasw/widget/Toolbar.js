...
define([
	...
	Widget._riasdMeta = {
		...
		initialSize: {},
		resizable: "none",
		allowedChild: "rias.riasw.form.Button, rias.riasw.form.ComboButton, rias.riasw.form.DropDownButton, rias.riasw.form.ToggleButton, rias.riasw.ToolbarSeparator",
		property: {
			tabIndex: {
				datatype: "string",
				defaultValue: "0",
