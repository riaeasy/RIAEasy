...
define([
	...
	_Widget.extend({
		templateString:
			'<span class="dijit dijitReset dijitInline dijitLeft" data-dojo-attach-point="_buttonNode,_popupStateNode" id="widget_${id}" role="listbox" aria-haspopup="true">'+
				'<span class="riaswTextBoxLabel" data-dojo-attach-point="labelNode" id="${id}_labelNode" tabIndex="-1" readonly="readonly" role="presentation"></span>'+
				'<span class="dijitInputField riaswTextBoxContainer" data-dojo-attach-point="containerNode,focusNode,textDirNode,_aroundNode" role="presentation">'+
					'<input type="text" class="riaswInputInner" data-dojo-attach-point="textbox" aria-labelledby="${id}_labelNode" role="textbox" readonly="readonly" ${!nameAttrSetting}/>'+
					...
					'</span>'+
				'</span>'+
				'<span class="riaswArrowButton riaswDownArrowButton riaswArrowButtonContainer" data-dojo-attach-point="titleNode" role="presentation">'+
				...
				'</span>'+
			'</span>',
		baseClass: "riaswSelect riaswValidationTextBox",

		cssStateNodes: {
			"titleNode": "riaswDownArrowButton"
		},
